...
const AboutSection = () => {
  return (
    <section id="about" className="home-section" style={{ minHeight: '50vh', padding: '4rem 0', position: 'relative', zIndex: 1 }}>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(8, 1fr)', width: '100%' }}>
        <div style={{ gridColumn: '2 / 8' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '1rem', lineHeight: '1.6' }}>
            placeholder for the about section. we will design this in the next steps.
          </p>
        </div>
      </div>
    </section>
